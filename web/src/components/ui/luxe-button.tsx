  ...
  },
  {
    ...
    component: ({ className, ...props }) => (
      <button
        {...props}
        className={cn(
          'rounded-xl bg-linear-to-t from-green-700 to-green-600 px-4 py-2 text-white',
          className
        )}
      />
    ),
  },
  {
    ...
    component: ({ className, ...props }) => (
      <button
        {...props}
        className={cn(
          'rounded-xl bg-linear-to-t from-red-600 to-red-500 px-4 py-2 text-white',
          className
        )}
      />
    ),
  },
  {
    ...
    component: ({ className, ...props }) => (
      <button
        {...props}
        className={cn(
          'animate-shine items-center justify-center rounded-xl border border-border bg-size-[400%_100%]',
      ...
      function GlitchText({
        ...
        return (
          <div className="relative overflow-hidden">
            <span className="invisible">{textChildren}</span>
